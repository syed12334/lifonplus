                        ...
                        <div class="modal-body">
                            <form id="category_form">
								...
								<div class="form-group">
                                    ...
                                    <textarea name="address" id="address" placeholder="Address Name" class="form-control" required /></textarea>
                                </div>
								...
								<div class="form-group">
                                    <label for="pan_no">PAN Number <font color="#FF0000">*</font></label>
                                     <input type="text" name="pan_no" id="pan_no" placeholder="PAN Number" class="form-control" required />
                                </div>
								
								<div class="form-group">
                                    <label for="gst_no">GST Number <font color="#FF0000">*</font></label>
                                     <input type="text" name="gst_no" id="gst_no" placeholder="GST Number" class="form-control" required />
                                </div>
								...
								<div class="form-group">
                                    <label for="account_no">Account Number <font color="#FF0000">*</font></label>
                                     <input type="text" name="account_no" id="account_no" placeholder="Account Number" class="form-control" required />
                                </div>
