    ...
    <body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-tools">
                             <a class="btn btn-success" href="<?php echo base_url();?>flashnews/add_flashnews" ><i class="fa fa-plus"></i> Add</a>
                            </div><hr>
                            
                            <table id="flashnews_table" class="table display table-bordered table-striped no-wrap" style="width:100%;">
                                <thead>
                                    <tr>
                                        <th>Sl. No.</th>
                                        <th>Action</th>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#flashnews_table').DataTable({  
                    "processing":true,  
                    "serverSide":true,  
                    "searching": true,
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'flashnews/flashnewsList'?>",  
                        type:"POST",
                        data: function(d){
           ...
           function modifyRow(id){
               document.location.href="<?php echo base_url();?>flashnews/edit_flashnews?id="+id;
            }

            function reinitialsedata(){
                var dt = $("#flashnews_table").DataTable();
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'flashnews/setFlashnewsStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
