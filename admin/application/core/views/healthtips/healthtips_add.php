        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        ...
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
							...
							<li class="breadcrumb-item active"><?php if($type == 1){?>Add<?php }else{?>Edit<?php }?>Health Tips</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add Health Tips</h4>
                            <div class="card-tools"></div><hr> 
                            <form id="category_form" method="post" onsubmit="return validateForm();" enctype="multipart/form-data" action="<?php echo base_url();?>healthtips/saveHealthTips">
							   ...
							   <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="<?=base_url().'healthtips'?>" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
                                    </div>
                                </div>            
					...
					<?php }else{?>
					 <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Health Tips</h4>
                            <div class="card-tools"></div><hr> 
                            <form id="category_form" onsubmit="return validateForm();" enctype="multipart/form-data" action="<?php echo base_url();?>healthtips/saveHealthTips" method="post">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="user_id" name="user_id[]" multiple="multiple">
                                          <?php 
											...
											$recipients = $this->master_db->getRecords('health_notify',array('health_id'=>$details[0]->id,'status'=>1),'GROUP_CONCAT(user_id) as user_id');
 ...
 <?php if($type == 1){?>
            ...
            function validateForm(){
			 ...
			 function loadUsers(){
                ...
                $.post("<?=base_url()?>healthtips/getUsers", {country_id:1,state:state,district:district,taluk:taluk}, function(data){
                    //console.log(data);
