...
<html dir="ltr" lang="en">
    ...
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Equipment/Items</h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Equipment/Items</h4>
        ...
        <script>
                ...
                dataTable = $('#category_table').DataTable({  
                    ...
                    "ajax":{  
                        ...
                        error: function(){  // error handling
                            ...
                            $("#user_data").append('<tbody class="user_data-error"><tr><th colspan="6">No data found in the server</th></tr></tbody>');
            ...
            function addNew(){
                $('#addModal').modal('show')
                $('#addModalLabel').html('Add Equipment/Items');
            }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'master/setItemStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                ...
                $.get("<?=base_url().'master/getItem/'?>"+id, {id:id}, function(data){
                    try{
                        Swal.close();
                        ...
                        if( json.status == 'success' ){
                            $('#addModal').modal('show')
                            $('#addModalLabel').html('Edit Equipment/Items');
                            $('#item_id').val(json.data.id);                            
                            $('#cat_id').val(json.data.cat_id);

                            var output = "<option value=''>--Select--</option>";
                            $(json.subcategory).each(function(){
                                if( this.id == json.data.subcat_id ){
                                    output += "<option value="+this.id+" selected >"+this.name+"</option>";
                                }else{
                                    output += "<option value="+this.id+">"+this.name+"</option>";
                                }                                
                            });
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="category_form">
                            ...
                            <div class="form-group">
                                <label for="name">Enter Equipment/Item Name</label>
                                <input type="text" name="name" id="name" placeholder="Equipment/Item Name" maxlength="100" class="form-control" required/>
                            </div>

                            <div class="form-group">
                                <label for="name">Enter Description</label>
                                <textarea name="descr" id="descr" rows="3" placeholder="Equipment/Item Name" maxlength="500" class="form-control"></textarea>
                            </div>
                        </form>
                    </div>
