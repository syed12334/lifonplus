    ...
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Taluk Name</h3>
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
                            <li class="breadcrumb-item"><a href="<?=base_url()?>">Dashboard</a></li>
                            <li class="breadcrumb-item active">Taluk Name</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Taluk Name</h4>
        ...
        <script>
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'home/saveTalukname'?>", str, function(data){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'home/setTalukStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                ...
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit Taluk')

                $.get("<?=base_url().'home/getTaluk_name/'?>"+id, {id:id}, function(data){
                    try{
                        var json = $.parseJSON(data);
                        console.log(json);
                        if( json.status == 'success' ){
                            $('#state_id').val(json.data.state_id);
                            $('#district_id').val(json.data.district_id);
			...
			if(state_id != ""){
				$.post("<?php echo base_url();?>home/get_district", {state_id: state_id}, function(data){
					if(data != ""){
						$("#district_id").html(data);
					}
					else{
						$("#district_id").html("District not created");
					}
				});
			}
	 }
                        ...
                        <div class="modal-body">
                            <form id="category_form">
								 ...
								 <div class="form-group">
									<label for="state_id">State Name<font color="#FF0000">*</font></label>
									<select name="state_id" id="state_id" class="form-control" required onchange="get_district();">
									<option value="">--Select--</option>
									   <?php 
									   $states = $this->master_db->getRecords('states');
										if(count($states)>0)
										{
											foreach($states as $s){?>
								...
								<div class="form-group">
									<label for="district_id">District Name<font color="#FF0000">*</font></label>
									<select name="district_id" id="district_id" class="form-control" required>
									<option value="">--Select--</option>
									</select>
                                </div>
                                <div class="form-group">
                                    <label for="name">Enter Taluk Name</label>
                                    <input type="text" name="name" id="name" placeholder="Taluk Name" class="form-control" required/>
