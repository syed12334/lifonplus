    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-success" href="<?php echo base_url();?>notifications/add_notify" ><i class="fa fa-plus"></i> Add</a>
                            </div><hr>
                            
                            <table id="notify_table" class="table display table-bordered table-striped no-wrap" style="width:100%;">
                                <thead>
                                    <tr>
                                        <th>Sl. No.</th>
                                        <th>Action</th>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#notify_table').DataTable({  
                    "processing":true,  
                    "serverSide":true,  
                    "searching": true,
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'notifications/notifyList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            function modifyRow(id){
               document.location.href="<?php echo base_url();?>notifications/edit_notify?id="+id;
            }
			
			

            function reinitialsedata(){
                var dt = $("#notify_table").DataTable();
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'notifications/setNotifyStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
