                        ...
                        <div class="card">
						   <?php echo $this->session->flashdata('message');?>
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url();?>others/saveabout" >
								  <div class="form-group">
								   <div class="col-8">
                                       <textarea id="mymce" name="about"><?=$about[0]->aboutus;?></textarea>
									</div>
								   </div>
									<div class="form-group">
									  <div class="form-group mb-0 text-center">
                                             <button type="submit" class="btn btn-info" id="saveButton" onclick="return validate();"><i class="fa fa-check"></i> Submit</button>
                                             <a href="<?php echo base_url();?>others/aboutus" class="btn btn-dark waves-effect waves-light">Cancel</a>
                                        </div>
