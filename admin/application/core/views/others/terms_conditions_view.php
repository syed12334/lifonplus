                        ...
                        <div class="card">
						   <?php echo $this->session->flashdata('message');?>
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url();?>others/saveterms" >
								  <div class="form-group">
								   <div class="col-8">
                                       <textarea id="mymce" name="terms"><?=$terms[0]->terms;?></textarea>
									</div>
								   </div>
									<div class="form-group">
									  <div class="form-group mb-0 text-center">
                                             <button type="submit" class="btn btn-info" id="saveButton" onclick="return validate();"><i class="fa fa-check"></i> Submit</button>
                                             <a href="<?php echo base_url();?>others/terms" class="btn btn-dark waves-effect waves-light">Cancel</a>
                                        </div>
    ...
    <script>
		...
		function validate()
		{
			if( $.trim(tinyMCE.get('mymce').getContent()) == '' ){
				Swal.fire('Enter Terms & Conditions');
				return false;
			}
		   return true;				
		}
