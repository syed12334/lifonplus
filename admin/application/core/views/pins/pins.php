    ...
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">PINS</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-3">
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <label for="status">Pin Type</label> 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-tools">
                                <a class="btn btn-success" href="<?=base_url().'pin/savepin'?>" ><i class="fa fa-plus"></i> Add</a>
        ...
        <script>
            ...
            function viewDetail(id){
                ...
                var postdata = {pin_id:id} ;
                $.ajax({                
                    url: "<?=base_url().'pin/viewPinHistory'?>",
                    type: "post",
                    data:  postdata ,
                    dataType : 'html',
                    success: function (response) {
                        console.log(response);
                        $('#viewModal #addModalLabel').html('Pin Transactions');
