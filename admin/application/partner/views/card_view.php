...
<body style="margin:0 0 0 0px!important; padding:0px!important; width:100%;">
    ...
    <table  style="width: 100%; margin:0; font-family:Arial, Helvetica, sans-serif; background-image: url('https://www.lifeonplus.com/assets/card_assets/img/background.jpg');background-size:cover; border-radius: 30px;position:relative; background-repeat: no-repeat; background-position: top left; "  border="0" cellpadding="0" cellspacing="0" >
