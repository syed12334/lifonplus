            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Add Package</h3>
                            ...
                            <form id="category_form" onsubmit="return validateForm();">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="color" name="color" id="color" placeholder="Select Colour" class="form-control" required/>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="card_type" id="card_type" class="form-control" required>
                                            <option value="">--Select--</option>
                                            <option value="1">Instant Digital Card</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="validity" id="validity" placeholder="Validity(No of Days)" class="form-control onlynumbers" required/>
                                    </div>

                                    <div class="col-md-4">
                                        <label for="price">Enter Package Price</label>
                                        <input type="text" name="price" id="price" placeholder="Package Price" class="form-control onlynumbers" required/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="descr" id="descr" placeholder="Description" class="form-control" maxlength="450" rows="3" required></textarea>
                                    </div>
                                </div>
