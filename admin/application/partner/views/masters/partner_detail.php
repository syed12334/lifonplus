                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <a target="_blank" href="<?=asset_url().$partner[0]->company_doc?>">Click here to view document</a>
                        </div>                        
                    </div>
                </div>
            </div>
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Individual Photo : <a target="_blank" href="<?=asset_url().$partner[0]->photo?>">Click here</a></label>
                        </div> 

                        <div class="col-md-6">
                            <label>KYC Document : <?=$kyc_type?></label><br>
                            <a target="_blank" href="<?=asset_url().$partner[0]->kyc_doc?>">Click here</a>
                        </div>                       
                    </div>
                </div>
            </div>
