            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <!-- <button class="btn btn-success" onclick="addNew();" ><i class="fa fa-upload"></i> Upload</button>-->
                       <!-- <a class="btn btn-success" href="<?=base_url().'master/upload_states'?>" ><i class="fa fa-file-excel"></i> Upload</a>-->
                        </div><hr>
    ...
    <script src="<?php echo asset_url();?>js/jquery.validate.min.js"></script>
        ...
        <script>
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'home/savestate'?>", str, function(data){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'home/setStateStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                ...
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit State')
                $.get("<?=base_url().'home/getState/'?>"+id, {id:id}, function(data){
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center">
                        <h4 class="modal-title" id="addModalLabel">Add State</h4>
                    ...
                    <div class="modal-body">
                        <form id="category_form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="State" class="form-control" required />
