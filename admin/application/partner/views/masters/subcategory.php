        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'master/subCategoryList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'master/saveSubCategory'?>", str, function(data){
            ...
            function addNew(){
                ...
                $('#addModal').modal('show')
                $('#addModalLabel').html('Add Sub-Category');
            }
            ...
            function modifyRow(id){
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit Sub-Category')

                $('#category_form #name').val('');
                $('#category_form #cat_id').val(0);
                $('#category_form #scat_id').val(0);

                $.get("<?=base_url().'master/getSubCategory/'?>"+id, {id:id}, function(data){
                    try{
                        ...
                        <div class="modal-body">
                            <form id="category_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="scat_id" id="scat_id" value="0" />
                                </div>
                            </form>
                            <div id="msg_box"></div>
                        </div>
