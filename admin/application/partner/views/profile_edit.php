                        ...
                        <form class="form-horizontal"  id="validate" >
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label><input type="checkbox" class="show" /> Show Password</label>
                                </div>
                            </div>
                            
                            <div class="form-group text-center" >
                                <a href="<?php echo base_url()?>Myprofile" type="button" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
