        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'flashnews/categoryList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'flashnews/saveCategory'?>", str, function(data){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'flashnews/setCategoryStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                ...
                $.get("<?=base_url().'flashnews/getCategory/'?>"+id, {id:id}, function(data){
                    try{
