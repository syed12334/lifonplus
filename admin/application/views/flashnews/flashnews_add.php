            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Flash News</h3>
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
                            <li class="breadcrumb-item"><a href="<?=base_url()?>">Dashboard</a></li>
                            <li class="breadcrumb-item active">Flash News</li>
							<li class="breadcrumb-item active"><?php if($type == 1){?>Add<?php }else{?>Edit<?php }?>Flash News</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add Flash News</h4>
                            <div class="card-tools"></div><hr> 
                            <form id="category_form" method="post" onsubmit="return validateForm();" enctype="multipart/form-data" action="<?php echo base_url();?>flashnews/saveFlashnews">
                                <input type="hidden" name="id" id="id" value="0" />
                                

							   <div class="form-group row">
									<label class="col-sm-2 text-right control-label col-form-label">Select Catgory</label>
									<div class="col-sm-6">
								...
								<div class="form-group row">
								 ...
								 <div class="form-group row">
                                    <label class="col-sm-2 text-right control-label col-form-label">Enter Date & Time</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="<?=base_url().'flashnews'?>" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
                                    </div>
                                </div>            
					...
					<?php }else{?>
					 <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Flash News</h4>
                            <div class="card-tools"></div><hr> 
                            <form id="category_form" onsubmit="return validateForm();" enctype="multipart/form-data" action="<?php echo base_url();?>flashnews/saveFlashnews" method="post">
							   ...
							   <div class="form-group row">
									...
									<div class="col-sm-6">
										<select name="cat_id" id="cat_id" class="form-control">
											...
											<?php if(count($category)){
												  foreach($category as $c){
											?>
											<option value="<?php echo $c->id;?>" <?php if($c->id==$details[0]->cat_id){?>selected<?php }?>><?php echo $c->name;?></option>		  
											<?php 
											   }
											}
                                            ?>											
								...
								<div class="form-group row">
								 ...
								 <div class="form-group row">
                                    <label class="col-sm-2 text-right control-label col-form-label">Enter Date & Time</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control datetimepicker" name="date_time" id="date_time" value="<?php echo date('d-m-Y h:i a',strtotime($details[0]->date_time));?>"/>
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control" id="state" name="state_id" onchange="loadUsers();">
										  <?php 
										   ...
										   ?>
                                                ...
                                                <option value="<?=$c->id;?>" <?php if($c->id==$details[0]->state_id){?>selected<?php }?>><?=$c->name;?></option>
										    <?php 
												}
											}
											?>
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="user_id" name="user_id[]" multiple="multiple">
                                          <?php 
											...
											$recipients = $this->master_db->getRecords('flashnews_notify',array('flash_id'=>$details[0]->id,'status'=>1),'GROUP_CONCAT(user_id) as user_id');
 ...
 <?php if($type == 1){?>
            ...
            function validateForm(){
			 ...
			 function loadUsers(){
                ...
                $.post("<?=base_url()?>flashnews/getUsers", {country_id:1,state:state,district:district,taluk:taluk}, function(data){
                    //console.log(data);
