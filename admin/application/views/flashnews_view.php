                      ...
                      <div class="page-banner-content">
                          <div class="d-sm-flex justify-content-between align-items-center">
                              ...
                              <div class="link text-sm-right text-left">
                                  ...
                                  <a href="#">Flashnews<i class="ti-angle-double-right"></i></a>
                                  Lifeon +
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-12">
                      <div class="blog-single-page">
                          <div class="blog-item">
                              <div class="blog-bg">
                                <?php
                                if( !empty($flash[0]->image) ){
                                  ?>
                                  <img src="<?=app_asset_url().$flash[0]->image?>" alt="Notification">
                                  <?php
                                }
                                ?>
                                <div class="overlay">
                              ...
                              <div class="blog-content">
                                  <h4><a href="#"><?=$flash[0]->title?></a></h4>
                                  <div class="">
                                      <span><?=$flash[0]->datetime?></span>
