            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Country</h3>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'master/getCountryList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'master/saveCountry'?>", str, function(data){
            ...
            function addNew(){
                $('#addModal').modal('show')
                $('#addModalLabel').html('Add Category')
            }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'master/setCoutryStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit Category')

                $.get("<?=base_url().'master/getCountry/'?>"+id, {id:id}, function(data){
                    try{
                        var json = $.parseJSON(data);
                        console.log(json);
                        if( json.status == 'success' ){
                            $('#cname').val(json.data.name);
                        ...
                        <div class="modal-body">
                            <form id="category_form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cname" id="cname" placeholder="Country Name" class="form-control" required/>
