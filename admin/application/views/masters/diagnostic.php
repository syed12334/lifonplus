...
<html dir="ltr" lang="en">
    <head>
        ...
        <!-- Favicon icon -->
        <?php echo $style;?>
        <title>Diagnostic Category</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Diagnostic Category</h3>
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
                            <li class="breadcrumb-item"><a href="<?=base_url()?>">Dashboard</a></li>
                            <li class="breadcrumb-item active">Diagnostic Category</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Diagnostic Category</h4>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'master/diagnosticList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'master/saveDiagnostic'?>", str, function(data){
            ...
            function addNew(){
                $('#addModal').modal('show')
                $('#addModalLabel').html('Add Diagnostic Category')
            }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'master/setDiagnosticStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit Diagnostic Category')

                $.get("<?=base_url().'master/getDiagnosticCategory/'?>"+id, {id:id}, function(data){
                    try{
                        ...
                        if( json.status == 'success' ){
                            ...
                            Swal.fire({
                                type: 'error',
                                title: '',
                                text: 'Diagnostic Category not found',
                            })
                        }
                    }catch (err) {
                        console.log(err);	
                        ...
                        <div class="modal-body">
                            <form id="category_form">
                                <div class="form-group">
                                    <label for="name">Enter Diagnostic Category Name</label>
