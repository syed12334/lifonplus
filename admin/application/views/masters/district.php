            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">District Name</h3>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'home/districtList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'home/savedistrict'?>", str, function(data){
            ...
            function addNew(){
                $('#addModal').modal('show')
                $('#addModalLabel').html('Add district')
            }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'home/setdistrictStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                ...
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit district')

                $.get("<?=base_url().'home/getdistrict/'?>"+id, {id:id}, function(data){
                    try{
                            ...
                            <form id="category_form">
								 <div class="form-group">
									...
									<option value="">--Select--</option>
									   <?php 
									   $states = $this->master_db->getRecords('states',['status'=>1],'*','name asc');
										if(count($states)>0)
										{
											foreach($states as $s){?>
								...
								<div class="form-group">
                                    <label for="name">District <font color="#FF0000">*</font></label>
                                    <input type="text" name="name" id="name" placeholder="District Name" class="form-control" required />
