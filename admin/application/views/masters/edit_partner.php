<?php
    //echo "<pre>";print_r($partnerpersonal);exit;
?>
<!DOCTYPE html>
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        ...
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
							...
							<li class="breadcrumb-item active">Edit Channel Partners</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="category_form" method="post" onsubmit="return validateForm();" enctype="multipart/form-data" action="<?php echo base_url();?>master/save_partner">
                                <input type="hidden" name="pid" id="pid" value="<?= $partners[0]->id?>" />
							   ...
							   <div class="form-group row">
									...
									<div class="col-sm-4">
										<select class="form-control" id="type" name="type">
                                                ...
                                                <option value="1" <?php if($partners[0]->type ==1) {echo "selected";}?>>COUNTRY PARTNER </option>
                                                
                                                <option value="3" <?php if($partners[0]->type ==3) {echo "selected";}?>>STATE C&F </option>
                                                <option value="4" <?php if($partners[0]->type ==4) {echo "selected";}?>>DISTRIBUTOR </option>
                                                <option value="5" <?php if($partners[0]->type ==5) {echo "selected";}?>>DEALER </option>
                                                <option value="6" <?php if($partners[0]->type ==6) {echo "selected";}?>>RETAILER </option>
                                            </select>   
									</div>
									...
									<div class="col-sm-4">
										 <input type="text" name="company_name" id="company_name" class="form-control" required data-error="Please enter your Company Name" placeholder="Company Name" value="<?php if(!empty($partners[0]->company_name)) {echo $partners[0]->company_name;}?>"> 
									</div>
								</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                         <select class="form-control" id="company_type" name="company_type">
                                                ...
                                                <option value="1" <?php if($partners[0]->company_type ==1) {echo "selected";}?>>PRIVATE LIMITED</option>
                                                <option value="2" <?php if($partners[0]->company_type ==2) {echo "selected";}?>>LIMITED </option>
                                                <option value="3" <?php if($partners[0]->company_type ==3) {echo "selected";}?>>PARTNERSHIP</option>
                                                <option value="4" <?php if($partners[0]->company_type ==4) {echo "selected";}?>>PROPRITOR</option>
                                                <option value="5" <?php if($partners[0]->company_type ==5) {echo "selected";}?>>LLP</option>
                                            </select>      
                                    </div>
                                        ...
                                        <select class="form-control" id="country" name="country">
                                            ...
                                            if(count($countries) >0) {
                                                foreach ($countries as $key => $value) {
                                                    $cid = $value->id;
                                                    ?>
                                                    <option value="<?= $value->id;?>" <?php if($cid  == $partnerpersonal[0]->country_id) {echo "selected";}?>><?= $value->name;?></option>
                                                    <?php
                                                }
                                            }
                                           ?>
                                           ...
                                           <?php
                                            if(count($state) >0) {
                                                foreach ($state as $key => $value) {
                                                    $sid = $value->id;
                                                    ?>
                                                    <option value="<?= $value->id;?>"  <?php if($sid  == $partnerpersonal[0]->state_id) {echo "selected";}?>  ><?= $value->name;?></option>
                                                    <?php
                                                }
                                            }
                                           ?>
                                           ...
                                           <?php
                                            if(count($district) >0) {
                                                foreach ($district as $key => $value) {
                                                    $did = $value->id;
                                                    ?>
                                                    <option value="<?= $value->id;?>" <?php if($did  == $partnerpersonal[0]->district_id) {echo "selected";}?> ><?= $value->name;?></option>
                                                    <?php
                                                }
                                            }
                                           ?>
                                           ...
                                           <?php
                                            if(count($taluk) >0) {
                                                foreach ($taluk as $key => $value) {
                                                    $tid = $value->id;
                                                    ?>
                                                    <option value="<?= $value->id;?>" <?php if($tid  == $partnerpersonal[0]->taluk_id) {echo "selected";}?> ><?= $value->name;?></option>
                                                    <?php
                                                }
                                            }
                                           ?>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                          <input type="text" name="gst_no" id="gst_no" class="form-control" maxlength="15" data-error="Please enter your gst no" placeholder="GST No" value="<?php if(!empty($partners[0]->gst_no)) {echo $partners[0]->gst_no;}?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4 ">
                                          <select class="form-control" id="doc_type" name="doc_type">
                                                ...
                                                <option value="1" <?php if($partners[0]->doc_type ==1) {echo "selected";} ?>>Incorporation </option>
                                                <option value="2" <?php if($partners[0]->doc_type ==2) {echo "selected";} ?>>Partnership Details </option>
                                          </select>
                                    </div>
                                </div>
							   ...
							   <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
									 ...
									 <?php
                                     if(!empty($partners[0]->company_doc)) {
                                            ?>
                                            <img src="<?= app_asset_url().$partners[0]->company_doc?>" style="width:100px">
                                            <?php
                                     }
                                     ?>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                          <input type="text" name="name" id="name" class="form-control" required data-error="Please enter your Full Name" placeholder="Full name" value="<?php if(!empty($partnerpersonal[0]->fullname)) {echo $partnerpersonal[0]->fullname;}?>">
                                    </div>
									
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Mobile Number</label>
                                    <div class="col-sm-4">
                                          <input class="form-control onlynumbers" type="text" maxlength="10" minlength="10" name="phone" id="phone" placeholder="Mobile Number" value="<?php if(!empty($partnerpersonal[0]->contactno)) {echo $partnerpersonal[0]->contactno;}?>">
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" name="email" id="email" class="form-control" required data-error="Please enter email" placeholder="Email Address" value="<?php if(!empty($partnerpersonal[0]->emailid)) {echo $partnerpersonal[0]->emailid;}?>">
                                    </div>
									
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Date of Birth</label>
                                    <div class="col-sm-4">
                                        <input placeholder="Date of Birth" name="dob" id="dob" type="date" class="form-control" value="<?php if(!empty($partnerpersonal[0]->dob)) {echo $partnerpersonal[0]->dob;}?>">
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="bloodgroup" name="bloodgroup">
                                                ...
                                                <option value="A-" <?php if($partnerpersonal[0]->bloodgroup=="A-") {echo "selected";}?>>A-</option>
                                                <option value="A+" <?php if($partnerpersonal[0]->bloodgroup=="A+") {echo "selected";}?>>A+</option>
                                                <option value="B-" <?php if($partnerpersonal[0]->bloodgroup=="B-") {echo "selected";}?>>B-</option>
                                                <option value="B+" <?php if($partnerpersonal[0]->bloodgroup=="B+") {echo "selected";}?>>B+</option>
                                                <option value="AB-" <?php if($partnerpersonal[0]->bloodgroup=="AB-") {echo "selected";}?>>AB-</option>
                                                <option value="AB+" <?php if($partnerpersonal[0]->bloodgroup=="AB+") {echo "selected";}?>>AB+</option>
                                                <option value="O+" <?php if($partnerpersonal[0]->bloodgroup=="O+") {echo "selected";}?>>O+</option>
                                                <option value="O-" <?php if($partnerpersonal[0]->bloodgroup=="O-") {echo "selected";}?>>O-</option>
                                                 <option value="A1+" <?php if($partnerpersonal[0]->bloodgroup=="A1+") {echo "selected";}?>>A1+</option>
                                                <option value="A2+" <?php if($partnerpersonal[0]->bloodgroup=="A2+") {echo "selected";}?>>A2+</option>
                                                <option value="A1B+" <?php if($partnerpersonal[0]->bloodgroup=="A1B+") {echo "selected";}?>>A1B+</option>
                                                <option value="A1B-" <?php if($partnerpersonal[0]->bloodgroup=="A-1B-") {echo "selected";}?>>A1B-</option>
                                          </select>
                                    </div>
									
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Address</label>
                                    <div class="col-sm-4">
                                       <textarea type="text" class="form-control clear_data" name="address" id="address" title="Enter Address" placeholder="Company Address"><?php if(!empty($partnerpersonal[0]->address)) {echo $partnerpersonal[0]->address;}?></textarea>
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                      <input type="text" name="pincode" id="pincode" class="form-control onlynumbers" maxlength="6" required data-error="Please enter your Pincode" placeholder="Pincode" value="<?php if(!empty($partnerpersonal[0]->pincode)) {echo $partnerpersonal[0]->pincode;}?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                      <input type="file" name="photo" id="photo" class="form-control" placeholder="Individual PHOTO: " accept=",.jpeg,.jpg">
                                            <span class="upload">UPLOAD JPG (100KB) </span>
                                              <?php
                                     if(!empty($partnerpersonal[0]->photo)) {
                                            ?>
                                            <img src="<?= app_asset_url().$partnerpersonal[0]->photo?>" style="width:100px">
                                            <?php
                                     }
                                     ?>
                                    </div>
								...
								<div class="form-group row">
								   ...
								   <div class="col-sm-4 ">
									 <select class="form-control" id="kyc_type" name="kyc_type">
										...
										<option value="1" <?php if($partnerpersonal[0]->kyc_type == 1) {echo "selected";}?>>AADHAAR CARD</option>
										<option value="2" <?php if($partnerpersonal[0]->kyc_type == 2) {echo "selected";}?>>PAN CARD</option>
										<option value="3" <?php if($partnerpersonal[0]->kyc_type == 3) {echo "selected";}?>>VOTER ID</option>
										<option value="4" <?php if($partnerpersonal[0]->kyc_type == 4) {echo "selected";}?>>PASSPORT</option>
									 </select>
									</div>
									
									 <label class="col-sm-2 text-right control-label col-form-label kyc_doc"  style="<?php if($partnerpersonal[0]->kyc_type ==1) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==2) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==3) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==4) {echo 'display: block!important';}?>" >Upload KYC Document</label>
                                    <div class="col-sm-4 kyc_doc" style="<?php if($partnerpersonal[0]->kyc_type ==1) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==2) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==3) {echo 'display: block!important';}else if($partnerpersonal[0]->kyc_type ==4) {echo 'display: block!important';}?>" >
									 <input type="file" name="kyc_doc" id="kyc_doc" class="form-control" placeholder="KYC UPLOAD" accept=".pdf,.jpeg,.jpg"  >
                                      <span class="upload">UPLOAD PDF,JPG (250KB) </span>
                                         <?php
                                     if(!empty($partnerpersonal[0]->kyc_doc)) {
                                            ?>
                                            <img src="<?= app_asset_url().$partnerpersonal[0]->kyc_doc?>" style="width:100px">
                                            <?php
                                     }
                                     ?>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                       <select class="form-control" id="payment_mode" name="payment_mode">
                                                ...
                                                <option value="1" <?php if($partnerpay[0]->payment_id ==1) {echo "selected";}?>>Cheque </option>
                                                <option value="2" <?php if($partnerpay[0]->payment_id ==2) {echo "selected";}?>>Cash </option>
                                                <option value="3" <?php if($partnerpay[0]->payment_id ==3) {echo "selected";}?>>RTGS </option>
                                                <option value="4" <?php if($partnerpay[0]->payment_id ==4) {echo "selected";}?>>Already paid to C&F/Distributor/Dealer </option>
                                            </select>  
                                    </div>
									
									
									 <label class="col-sm-2 text-right control-label col-form-label rtgsinput" style="<?php if($partnerpay[0]->payment_id ==3) {echo 'display:block!important';}?>">Enter UTR No</label>
                                    <div class="col-sm-4 rtgsinput" style="<?php if($partnerpay[0]->payment_id ==3) {echo 'display:block!important';}?>">
									   <input type="text" name="utr_no" id="utr_no" class="form-control"  placeholder="UTR NO">
									</div>
                                </div>
								
								
								<div class="form-group row chequeinput" style="<?php if($partnerpay[0]->payment_id ==1) {'display: block!important';} ?>">
                                   
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Cheque Number</label>
                                    <div class="col-sm-4">
                                       <input type="text" name="cheque_no" id="cheque_no" class="form-control"  placeholder="Cheque Number" value="<?php if(!empty($partnerpay[0]->cheque_no))  {echo $partnerpay[0]->cheque_no;}?>">
                                    </div>
									
									
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Cheque Date</label>
                                    <div class="col-sm-4">
									    <input type="date" placeholder="Cheque Date" name="cheque_date" id="cheque_date" class="form-control"  placeholder="Date" value="<?php if(!empty($partnerpay[0]->cheque_date))  {echo $partnerpay[0]->cheque_date;}?>">
									</div>
                                </div>
								...
								<div class="form-group row chequeinput" style="<?php if($partnerpay[0]->payment_id ==1) {'display: block!important';} ?>">
                                    ...
                                    <div class="col-sm-4">
                                       <input type="text" name="bank_name" id="bank_name" class="form-control"  placeholder="Enter Bank Name" value="<?php if(!empty($partnerpay[0]->bank_name))  {echo $partnerpay[0]->bank_name;}?>">
                                    </div>
									
									
									 <label class="col-sm-2 text-right control-label col-form-label">Enter Branch Name</label>
                                    <div class="col-sm-4">
									    <input type="text" placeholder="Branch Name" name="branch_name" id="branch_name" class="form-control"  placeholder="Branch Name" value="<?php if(!empty($partnerpay[0]->branch_name))  {echo $partnerpay[0]->branch_name;}?>">
									</div>
                                </div>
    	   ...
    	   function checkEligible(data = ''){
            ...
            function validateForm(){
               ...
               /* if( $('#terms').is(':checked') == false ){
                ...
                $.ajax({
                    url : "<?=base_url()?>master/savePartners",
                    type: 'POST',
                    dataType: 'json',
                    data: formData,
                    crossDomain: true,
