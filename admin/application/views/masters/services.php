...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-tools">
                            ...
                            <a class="btn btn-success" href="<?=base_url().'master/service_field_save'?>" ><i class="fa fa-plus"></i> Add Service Fields</a>
                        </div><hr>
    ...
    <script>
        ...
        function modifyFields(id){
            Swal.fire({
                title: '',
                text: 'Are you sure want to edit fields?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                var url = "<?=base_url()?>master/service_field_save/"+id;
                window.open(url);
            });    
        }
    </script>
