...
<body>
    ...
    <script>
            ...
            dataTable = $('#category_table').DataTable({  
                ...
                "ajax":{  
                    ...
                    error: function(){  // error handling
                        ...
                        $("#user_data").append('<tbody class="user_data-error"><tr><th colspan="4">No data found in the server</th></tr></tbody>');
            ...
            $("#saveButton").click(function(evt){
                if(v.form()){
                    ...
                    var str = $("#category_form").serialize();
      				...
      				$.post("<?=base_url().'master/saveUnit'?>", str, function(data){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "<?=base_url().'master/setUnitStatus'?>",
                        type: "post",
                        data:  postdata ,
                        dataType : 'json',
        ...
        function modifyRow(id){
            console.log(id)
            $('#addModal').modal('show')
            $('#addModalLabel').html('Edit Unit')

            $.get("<?=base_url().'master/getUnit/'?>"+id, {id:id}, function(data){
	    		try{
                    ...
                    <div class="modal-body">
                        <form id="category_form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Unit Name" class="form-control" required/>
