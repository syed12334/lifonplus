...
<html lang="en">
  <head>
    ...
    <title>Lifeon + Popupalerts</title>
                      ...
                      <div class="page-banner-content">
                          <div class="d-sm-flex justify-content-between align-items-center">
                              ...
                              <div class="link text-sm-right text-left">
                                  ...
                                  <a href="#">Popupalerts<i class="ti-angle-double-right"></i></a>
                                  Lifeon +
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-12">
                      <div class="blog-single-page">
                          <div class="blog-item">
                              <div class="blog-bg">
                                <?php
                                if( !empty($popup[0]->image_path) ){
                                  ?>
                                  <img src="<?=app_asset_url().$popup[0]->image_path?>" alt="Notification">
                                  <?php
                                }
                                ?>
                                <div class="overlay">
                              ...
                              <div class="blog-content">
                                  <h4><a href="#"><?=$popup[0]->title?></a></h4>
                                  <div class="">
                                      <span><?php if(!empty($popup[0]->datetime)) { echo date('d-m-Y',strtotime($popup[0]->datetime));}?></span>
