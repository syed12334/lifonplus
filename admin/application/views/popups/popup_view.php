            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Popup Alerts</h3>
                        <ol class="breadcrumb mb-0 p-0 bg-transparent">
                            <li class="breadcrumb-item"><a href="<?=base_url()?>">Dashboard</a></li>
							<li class="breadcrumb-item active">Notifications</li>
                            <li class="breadcrumb-item active">Popup Alerts</li>
                        </ol>
                    </div>
                </div>
                <!-- Container fluid  -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Popup Alerts</h4>
                            <div class="card-tools">
                            <a class="btn btn-success" href="<?php echo base_url();?>popupalert/add_popups" ><i class="fa fa-plus"></i> Add</a>
                            </div><hr>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#healthtips_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'popupalert/popupalertList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            function modifyRow(id){
               document.location.href="<?php echo base_url();?>popupalert/edit_popups?id="+id;
            }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'popupalert/setPopupalertStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
