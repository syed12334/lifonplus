            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-12 align-self-center">
                        <h3 class="text-themecolor mb-0">Time Slot</h3>
        ...
        <script>
            ...
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'master/timeslotList'?>",  
                        type:"POST",
                        data: function(d){
            ...
            $(document).ready(function(){ 
                ...
                $("#saveButton").click(function(evt){
                    ...
                    if(v.form()){
                        ...
                        $.post("<?=base_url().'master/saveTimeslot'?>", str, function(data){
                            if(parseInt(data) == 1){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            url: "<?=base_url().'master/setTimeslotStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
            ...
            function modifyRow(id){
                console.log(id)
                $('#addModal').modal('show')
                $('#addModalLabel').html('Edit Timeslot')

                $.get("<?=base_url().'master/getTimeslot/'?>"+id, {id:id}, function(data){
                    try{
                        var json = $.parseJSON(data);
                       // console.log(json);
                        if( json.status == 'success' ){
                            $('#days').val(json.data.days);
                            $('#wday').val(json.data.wday);
                            $('#timings').val(json.data.timings);
                            $('#id').val(json.data.id);
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="category_form">
                                ...
                                <div class="form-group">
                                    <label for="price">Enter Timings</label>
                                    <input type="text" name="timings" id="timings" placeholder="Enter Timings" class="form-control" title="Enter Timings"/>
